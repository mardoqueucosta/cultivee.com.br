---
titulo: 'Glossário Técnico de Hidroponia e Cultivo Protegido'
resumo: >-
  Glossário de hidroponia com 70 termos definidos: pH, EC, NFT, DFT, DLI, VPD,
  PPFD e mais, com faixa-alvo numérica e fonte primária brasileira.
categoria: 'Agro'
...
leitura: '16 min'
tldr: >-
  Este glossário reúne 70 termos técnicos de hidroponia e cultivo protegido
  organizados em sete blocos temáticos, cada um com definição curta, faixa-alvo
  numérica e fonte. Os três parâmetros que aparecem em quase toda conversa
  técnica são pH (5,5 a 6,5 para folhosas), condutividade elétrica (1,5 a 2,5
  mS/cm) e DLI (12 a 17 mol·m⁻²·d⁻¹ para alface). Use o sumário para saltar
  direto ao bloco do termo que você procura.
imagens:
  - src: /blog/glossario-tecnico-de-hidroponia-e-cultivo-protegido/maos-de-produtor-medindo-ph-da-solucao-nutritiva-com-so-1.jpg
    alt: 'Mãos de produtor medindo pH da solução nutritiva com sonda digital ao lado de perfis NFT com alface'
    caption: 'A medição de pH e EC é o gesto que transforma vocabulário técnico em manejo diário'
  - src: /blog/glossario-tecnico-de-hidroponia-e-cultivo-protegido/mudas-de-alface-em-cubos-de-espuma-fenolica-com-raizes--2.jpg
    alt: 'Mudas de alface em cubos de espuma fenólica com raízes emergindo, prontas para transplante em hidroponia'
    caption: 'Mudas em espuma fenólica no ponto de transplante, com raízes já ultrapassando a base do cubo'
  - src: /blog/glossario-tecnico-de-hidroponia-e-cultivo-protegido/prateleiras-de-folhosas-hidroponicas-sob-led-em-fazenda-3.jpg
    alt: 'Prateleiras de folhosas hidropônicas sob LED em fazenda vertical, ilustrando DLI e PPFD em ambiente controlado'
    caption: 'Em ambiente controlado, a luz entregue é medida em PPFD e acumulada como DLI ao longo do dia'
---
...
| Termo âncora | Faixa-alvo prática | Fonte |
| --- | --- | --- |
| pH da solução | 5,5 a 6,5 (folhosas) | Furlani, IAC (2018) |
| Condutividade elétrica (EC/CE) | 1,5 a 2,5 mS/cm | Furlani, IAC (2018) |
| DLI para alface | 12 a 17 mol·m⁻²·d⁻¹ | Fluence |

> Segundo a Embrapa Hortaliças, hidroponia é a técnica de cultivo de plantas sem solo, em que o suprimento de nutrientes ocorre por meio de solução nutritiva ([Circular Técnica nº 22, Princípios de Hidroponia](https://www.infoteca.cnptia.embrapa.br/infoteca/bitstream/doc/769981/1/CNPHDOCUMENTOS22PRINCIPIOSDEHIDROPONIA.pdf)).

> Leia também: [O que é hidroponia: guia definitivo](/blog/o-que-e-hidroponia-guia-definitivo-vantagens-tipos-e-como-co)
...
![Mãos de produtor medindo pH da solução nutritiva com sonda digital ao lado de perfis NFT com alface](/blog/glossario-tecnico-de-hidroponia-e-cultivo-protegido/maos-de-produtor-medindo-ph-da-solucao-nutritiva-com-so-1.jpg)
...
> Leia também: [NFT, DFT e floating: comparativo completo de sistemas hidropônicos](/blog/nft-vs-dft-vs-floating-comparativo-completo-de-sistemas-hidr)
...
**Condutividade elétrica (EC ou CE).** Capacidade da solução de conduzir corrente elétrica, usada como proxy da concentração total de sais dissolvidos. Folhosas operam bem entre 1,5 e 2,5 mS/cm, com alface em torno de 1,8, e tomate entre 2,5 e 3,5, segundo [Pedro Furlani, do IAC](http://www.encontrohidroponia.com.br/images/site/palestras/Pedro_Furlani_2018.pdf). EC informa quanto sal existe, nunca qual sal.
...
> Leia também: [Solução nutritiva para hidroponia: guia completo com calculadora](/blog/solucao-nutritiva-para-hidroponia-guia-completo-calculadora)
...
Para preparar solução na prática, com tabelas de sais escaladas por volume, o caminho é o [guia passo a passo de preparo](/blog/como-preparar-solucao-nutritiva-passo-a-passo-tabelas-para-1).
...
![Mudas de alface em cubos de espuma fenólica com raízes emergindo, prontas para transplante em hidroponia](/blog/glossario-tecnico-de-hidroponia-e-cultivo-protegido/mudas-de-alface-em-cubos-de-espuma-fenolica-com-raizes--2.jpg)
...
| Substrato | Origem | Retenção de água | CTC | Reuso | Uso principal |
| --- | --- | --- | --- | --- | --- |
| Espuma fenólica | Sintética | Alta | Nula | Não | Berçário de folhosas |
| Lã de rocha | Mineral (basalto) | Alta | Baixa | Limitado | Tomate e pepino em estufa |
| Fibra de coco | Orgânica (coco) | Alta | Alta | Sim, 2 a 3 ciclos | Frutos e vasos |
| Perlita | Mineral (vulcânica) | Baixa | Nula | Sim | Mistura para drenagem |
| Vermiculita | Mineral (mica) | Muito alta | Alta | Não | Cobertura de semeadura |
| Argila expandida | Cerâmica | Baixa | Baixa | Sim, vários ciclos | Media bed e aquaponia |

## Bloco 5: ambiente e luz

**DLI (Daily Light Integral).** Total de fótons PAR que 1 m² recebe ao longo de um dia inteiro, em mol·m⁻²·d⁻¹. Calcula-se por PPFD × horas de luz × 0,0036. Alface pede de 12 a 17 mol·m⁻²·d⁻¹ e tomate em produção de 20 a 30, conforme a [Fluence](https://fluence-led.com/commercial-cannabis/science/introducing-the-concept-of-dli-to-the-world/). É o número que decide se você precisa de luz suplementar, não o PPFD isolado.
![Prateleiras de folhosas hidropônicas sob LED em fazenda vertical, ilustrando DLI e PPFD em ambiente controlado](/blog/glossario-tecnico-de-hidroponia-e-cultivo-protegido/prateleiras-de-folhosas-hidroponicas-sob-led-em-fazenda-3.jpg)
...
**PAR (Radiação Fotossinteticamente Ativa).** Faixa do espectro entre 400 e 700 nm, que é a luz efetivamente usada na fotossíntese, conforme a [University of Missouri Extension](https://extension.missouri.edu/publications/g6987). PAR descreve a faixa, não a intensidade.
...
> Leia também: [Iluminação LED para plantas: espectro, DLI e PPFD](/blog/iluminacao-led-para-plantas-espectro-dli-e-ppfd)
...
**Rastreabilidade.** Capacidade de identificar a origem e o histórico de um lote de hortaliça, exigida pela Instrução Normativa Conjunta nº 2/2018 de ANVISA e MAPA, disponível no [repositório oficial DataLegis](https://anvisalegis.datalegis.net/). Alcança o produto hidropônico como qualquer outro vegetal fresco.
...
| Sigla | Inglês | Português usual | Observação de tradução |
| --- | --- | --- | --- |
| NFT | Nutrient Film Technique | Técnica do filme de nutrientes | "Filme" é a lâmina fina, não um material |
| DWC | Deep Water Culture | Cultivo em água profunda | Na prática BR aparece como DFT ou floating |
| CEA | Controlled Environment Agriculture | Agricultura em ambiente controlado | "Protegido" não é sinônimo de "controlado" |
| VPD | Vapor Pressure Deficit | Déficit de pressão de vapor | Nunca traduzir como "umidade" |
| EC | Electrical Conductivity | Condutividade elétrica (CE) | A Embrapa usa CE; o mercado usa EC |
| PPFD | Photosynthetic Photon Flux Density | Densidade de fluxo de fótons | Instantâneo, diferente de DLI |
| DLI | Daily Light Integral | Integral diária de luz | Acumulado do dia |
| HVAC | Heating, Ventilation, Air Conditioning | Climatização | Em CEA inclui desumidificação, o item mais caro |
...
Se o próximo passo é montar algo, o caminho prático está em [hidroponia caseira passo a passo](/blog/hidroponia-caseira-passo-a-passo-monte-seu-sistema-em-casa) e, para quem tem varanda, em [horta vertical hidropônica residencial](/blog/horta-vertical-hidroponica-residencial-como-montar-a-sua). Para a primeira cultura, alface continua sendo a escolha de menor risco, conforme o [guia completo de alface hidropônica](/blog/guia-completo-de-alface-hidroponica-do-plantio-caseiro-a-pro). Para quem quer testar mercado com ciclo curto, vale o [guia de microverdes em casa](/blog/como-iniciar-cultivo-microverdes-em-casa) e o [panorama de viabilidade dos microgreens](/blog/microgreens-guia-completo-de-cultivo-comercial-e-viabilidade). Quem for automatizar leitura de pH e EC encontra a base em [sensores na agricultura](/blog/automacao-e-iot-em-hidroponia-com-esp32-guia-completo-de-sen).

> Segundo a [Mordor Intelligence](https://www.mordorintelligence.com/pt/industry-reports/hydroponics-market), o mercado global de hidroponia foi estimado em cerca de US$ 6,8 bilhões em 2026, com projeção de atingir US$ 11,1 bilhões em 2031, um crescimento anual composto de aproximadamente 10,3%.
