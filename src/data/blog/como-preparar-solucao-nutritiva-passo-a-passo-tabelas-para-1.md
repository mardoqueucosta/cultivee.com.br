---
titulo: 'Como Preparar Solução Nutritiva Passo a Passo: Tabelas para 100L, 500L e 1.000L [2026]'
resumo: >-
  Guia prático para preparar solução nutritiva Furlani em casa, com tabelas
  escaladas para 100, 500 e 1.000 litros, sais comerciais brasileiros e
  procedimento passo a passo de soluções A e B.
categoria: 'Agro'
...
leitura: '22 min'
tldr: >-
  Preparar solução nutritiva é traduzir uma receita em mg/L (publicada por
  pesquisa científica) em gramas de fertilizante por volume real do
  reservatório. Este guia entrega tabelas escaladas para 100, 500 e 1.000
  litros, com a fórmula Furlani (IAC, 1998), sais brasileiros disponíveis no
  varejo, procedimento passo a passo de soluções concentradas A e B, custo
  comparativo (R$ 20 caseiro vs R$ 49 a R$ 80 em kit pronto) e os 10 erros
  mais comuns a evitar.
imagens:
  - src: /blog/como-preparar-solucao-nutritiva-passo-a-passo-tabelas-para-1/preparo-de-solucao-nutritiva-furlani-com-balanca-digita-1.jpg
    alt: 'Preparo de solução nutritiva Furlani com balança digital sais e canetas de pH e EC'
    caption: Preparo passo a passo da solução Furlani, com sais separados em soluções A e B.
  - src: /blog/como-preparar-solucao-nutritiva-passo-a-passo-tabelas-para-1/medicao-diaria-de-ph-e-ec-com-canetas-digitais-em-reser-2.jpg
    alt: 'Medição diária de pH e EC com canetas digitais em reservatório de solução nutritiva'
    caption: 'Medição diária de pH e EC, fundamental para o manejo correto da solução nutritiva.'
  - src: /blog/como-preparar-solucao-nutritiva-passo-a-passo-tabelas-para-1/comparativo-entre-solucao-nutritiva-preparada-corretame-3.jpg
    alt: 'Comparativo entre solução nutritiva preparada corretamente e solução com precipitação de sais'
    caption: 'À esquerda, solução correta; à direita, precipitação por mistura indevida de cálcio e sulfato.'
---
Preparar solução nutritiva é uma das habilidades técnicas mais importantes para o produtor hidropônico brasileiro. A receita canônica é a [Furlani (IAC, 1998)](https://www.bdpa.cnptia.embrapa.br/consulta/busca?b=ad&busca=autoria:%22FURLANI,+P.+R.%22), descrita no Boletim Técnico nº 168 do Instituto Agronômico de Campinas e ainda hoje a base de 80% das operações comerciais brasileiras de folhosas. Mas a receita acadêmica vem em miligramas por litro (mg/L), e quem está com balde de 100, 500 ou 1.000 litros na frente precisa traduzir isso em gramas dos sais disponíveis no varejo brasileiro. Este guia faz exatamente essa ponte.
...
![Preparo de solução nutritiva Furlani com balança digital sais e canetas de pH e EC](/blog/como-preparar-solucao-nutritiva-passo-a-passo-tabelas-para-1/preparo-de-solucao-nutritiva-furlani-com-balanca-digita-1.jpg)
*Preparo passo a passo da solução Furlani, com sais separados em soluções A e B.*
...
![Medição diária de pH e EC com canetas digitais em reservatório de solução nutritiva](/blog/como-preparar-solucao-nutritiva-passo-a-passo-tabelas-para-1/medicao-diaria-de-ph-e-ec-com-canetas-digitais-em-reser-2.jpg)
*Medição diária de pH e EC, fundamental para o manejo correto da solução nutritiva.*
...
![Comparativo entre solução nutritiva preparada corretamente e solução com precipitação de sais](/blog/como-preparar-solucao-nutritiva-passo-a-passo-tabelas-para-1/comparativo-entre-solucao-nutritiva-preparada-corretame-3.jpg)
*À esquerda, solução correta; à direita, precipitação por mistura indevida de cálcio e sulfato.*


1. **Usar água da torneira sem testar alcalinidade e cloro.** Águas duras adicionam cálcio e magnésio extras à fórmula, e cloro residual queima raízes jovens. Sempre fazer análise prévia ou pelo menos deixar a água descansar 24 horas em recipiente aberto.

2. **Misturar nitrato de cálcio com sulfato ou fosfato no mesmo balde concentrado.** Provoca precipitação imediata de gesso (CaSO₄) ou fosfato tricálcico (Ca₃(PO₄)₂), tirando esses nutrientes da disponibilidade. Sempre dois recipientes A e B separados.

3. **Ajustar o pH antes de adicionar todos os sais.** O pH muda à medida que sais são adicionados. Sempre dissolver primeiro todos os sais, aguardar 30 minutos para homogeneização, e só então medir e ajustar o pH.

4. **Trocar fertilizante hidropônico por NPK granulado de solo.** Adubos formulados para solo (NPK 04-14-08, 20-05-20) contêm cargas de fillers e formas pouco solúveis. A IN MAPA 46/2016 exige fertilizantes totalmente solúveis em água para hidroponia. Use sais simples puros ou pré-misturas certificadas.

5. **Não repor água evaporada.** A planta consome água mais rápido que íons, então o reservatório vai concentrando ao longo do tempo se não houver reposição de água. Conferir o nível diariamente e completar com água até atingir o nível original.

6. **Repor sais sem repor água primeiro.** O procedimento correto é: completar com água até o nível original, medir EC, e só então adicionar mais solução B se a EC estiver baixa. Adicionar sal antes de água gera concentração excessiva pontual.

7. **Não calibrar o peagâmetro e o condutivímetro.** Equipamentos digitais precisam de calibração regular com soluções padrão (pH 4,01, pH 6,86 e EC 1413 μS/cm). Sem calibração, o aparelho mente e o produtor manaja errado. Calibrar a cada 2 a 4 semanas é o padrão.

8. **Fazer ajustes grandes e bruscos em vez de incrementais.** Adicionar muito ácido ou muita base de uma vez gera oscilações que estressam as plantas. O padrão é adicionar em pequenas porções, agitar e aguardar 5 minutos antes de medir novamente.
