...
No horizonte de fertirrigação, a tendência mais concreta é a dos **sensores dentro do substrato**. Sensores de umidade volumétrica e de condutividade da água de poro (porewater EC) instalados no slab permitem decidir a irrigação em tempo real, em vez de por horário fixo. Quem quiser entender esse universo de instrumentação encontra um bom ponto de partida no [guia de sensores para agricultura](/blog/sensores-agricultura-guia-escolha-implementacao), que cobre a lógica de escolha e implementação desses equipamentos.
