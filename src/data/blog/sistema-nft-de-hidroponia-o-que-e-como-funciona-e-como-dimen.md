---
titulo: 'Sistema NFT de Hidroponia: O Que É, Como Funciona e Como Dimensionar [2026]'
resumo: >-
  Guia técnico completo do sistema NFT de hidroponia, da origem em 1965 ao
  dimensionamento passo a passo, com receita Furlani, cases brasileiros e
  layouts piramidais que chegam a 14 kg de alface por metro quadrado.
categoria: 'Agro'
...
tldr: >-
  ...
  Allen Cooper e hoje o sistema dominante no Brasil para folhosas. A receita
  técnica é simples: declividade de 2 a 7%, vazão de 1,5 a 2 litros por minuto
  por perfil, comprimento máximo de 12 metros, EC entre 1,0 e 2,0 dS/m, pH
  entre 5,5 e 6,5 e solução nutritiva Furlani (IAC, 1998). Com isso, fazendas
  urbanas como a Pink Farms produzem 2,5 toneladas de folhosas por mês em 750
  metros quadrados, com 95% menos água que o cultivo no solo.
imagens:
  - src: /blog/sistema-nft-de-hidroponia-o-que-e-como-funciona-e-como-dimen/bancada-nft-em-operacao-com-perfis-brancos-inclinados-e-1.jpg
    alt: 'Bancada NFT em operação com perfis brancos inclinados e alfaces crespas verdes em estufa'
    caption: 'Bancada NFT em operação, com declividade visível, perfis brancos e alfaces em fase final.'
  - src: /blog/sistema-nft-de-hidroponia-o-que-e-como-funciona-e-como-dimen/preparo-da-solucao-nutritiva-furlani-em-recipientes-a-e-2.jpg
    alt: Preparo da solução nutritiva Furlani em recipientes A e B com canetas de pH e EC
    caption: Preparo da solução Furlani em soluções A e B separadas, com medição de pH e EC.
  - src: /blog/sistema-nft-de-hidroponia-o-que-e-como-funciona-e-como-dimen/comparativo-entre-raizes-hidroponicas-saudaveis-e-raize-3.jpg
...
![Bancada NFT em operação com perfis brancos inclinados e alfaces crespas verdes em estufa](/blog/sistema-nft-de-hidroponia-o-que-e-como-funciona-e-como-dimen/bancada-nft-em-operacao-com-perfis-brancos-inclinados-e-1.jpg)
*Bancada NFT em operação, com declividade visível, perfis brancos e alfaces em fase final.*
...
**Etapa 2: área útil de perfis.** Com densidade recomendada por [Gualberto et al. (1999)](https://www.scielo.br/j/hb/a/DxLgPDFwfnXq5qB7xmC5k5P/) de 20 plantas por metro quadrado em espaçamento 25 × 20 cm, 5.300 plantas exigem **265 metros quadrados de perfis úteis**.
...
![Comparativo entre raízes hidropônicas saudáveis e raízes contaminadas por Pythium em NFT](/blog/sistema-nft-de-hidroponia-o-que-e-como-funciona-e-como-dimen/comparativo-entre-raizes-hidroponicas-saudaveis-e-raize-3.jpg)
*À esquerda, raiz branca saudável em NFT; à direita, raiz marrom indicando Pythium por temperatura excessiva.*


1. **Perfil acima de 12 metros de comprimento.** O nitrogênio depleta no fim da bancada, resultando em plantas menores nos últimos furos. Cooper já apontava esse limite em 1965, e a recomendação é consensual em todas as fontes técnicas brasileiras.
2. **Declividade abaixo de 2%.** Gera empoçamento e zonas anóxicas, com podridão de raiz por *Pythium*. A correção exige reerguer o perfil ou inclinar a bancada com cunhas de madeira ou metal.
3. **Bomba subdimensionada.** Em uma bancada de 20 perfis, a vazão mínima é de 1.800 a 2.400 L/h. Bombas de 1.000 L/h não suprem o sistema, e os perfis nas pontas mais distantes ficam sem fluxo adequado.
4. **Reservatório pequeno.** Volumes inferiores a 0,5 litro por planta amplificam flutuações de pH e EC, dificultando o manejo. Em produção comercial, sempre dimensionar com folga.
5. **Temperatura da solução acima de 30 °C.** Causa dano físico em raízes e dispara *Pythium*. Sombreamento da estufa, isolamento térmico do reservatório e, em casos extremos, chillers refrigerados são as soluções.
...
**Cenário 1: protótipo NFT de baixo custo (UFMS, 2022).** [Espanholo Kaus Santos e colegas](https://periodicos.ufms.br/index.php/EIGEDIN/article/download/11353/8226/), em projeto da UFMS publicado em 2022, montaram sistema NFT artesanal com 576 plantas (berçário e três bancadas finais) por **R$ 3.389,44 de investimento total**, equivalente a R$ 5,89 por posição de cultivo. O custo unitário de produção mensal foi de R$ 0,28 por planta para uma produção mensal de 30.000 plantas. É a referência de custo mais transparente publicada na literatura brasileira.
...
**Cenário 3: vertical farming comercial (Pink Farms).** O CAPEX por metro quadrado em fazenda vertical urbana é alto. A Pink Farms levantou R$ 15 milhões em Série A para escalar uma operação que hoje produz 2,5 toneladas por mês em 750 metros quadrados de galpão com 8 níveis. Energia elétrica representa cerca de **40% do OPEX**, segundo reportagens setoriais, sendo o principal desafio econômico do modelo. Linhas de [BNDES Inovagro](https://www.bndes.gov.br) e investimento privado em agritechs são as fontes principais de capital para esse porte.

Para o produtor familiar interessado em começar, a [PRONAF Mais Alimentos](https://www.gov.br/agricultura/pt-br/assuntos/sustentabilidade/agricultura-familiar/pronaf-e-pronamp) oferece linhas de financiamento com juros reduzidos para implantação de sistemas de irrigação, interpretação que cobre NFT em propriedades familiares. A nova [Lei nº 14.935/2024](https://www12.senado.leg.br/noticias/materias/2024/07/29/lei-cria-a-politica-nacional-de-agricultura-urbana-e-periurbana), que criou a Política Nacional de Agricultura Urbana e Periurbana (PNAU), abre linhas adicionais para hidroponia em contexto urbano e periurbano, com regulamentação operacional em curso.
